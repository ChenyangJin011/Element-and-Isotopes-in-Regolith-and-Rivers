# -*- coding: utf-8 -*-
"""
Created on Tue Dec 31 16:10:30 2024
compard to comb_mcmc.py, this code uses fixed values and different system cases to help with result description
@author: Chenyang
...
while not finished:
    ...
    # 2. the initial solution is balanced with the soil atmosphere, then minerals dissolve by pH increment
       ...
       # while x < x_degas: # this is for degas
        ...
        if iteration_calcite <= n_gw_prec:
            phase = 'groundwater_precipitation'
